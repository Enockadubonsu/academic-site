...
Code and reproducible workflows are on [GitHub](https://github.com/Enockadubonsu). I contribute to **TSGap**, an open-source Python library for composable time-series missingness simulation, separating missingness mechanisms (MCAR/MAR/MNAR) from patterns for imputation-method benchmarking.
